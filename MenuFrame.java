...
public class MenuFrame extends JFrame {
    ...
    public MenuFrame() {
        ...
        // for Pizza
        JLabel pizzaImg = new JLabel(new ImageIcon("C:\\Users\\HP\\Documents\\project visual\\practicle\\src\\pizza.jpg"));
        ...
        pizzaSpinner = new JSpinner(new SpinnerNumberModel(1, 1, 20, 1)); // يبدا من 1 لحد 20
        pizzaSpinner.setBounds(320, 60, 50, 30);
        // for Burger
        JLabel burgerImg = new JLabel(new ImageIcon("C:\\Users\\HP\\Documents\\project visual\\practicle\\src\\burger.jpg"));
        ...
        // Salad
        JLabel saladImg = new JLabel(new ImageIcon("C:\\Users\\HP\\Documents\\project visual\\practicle\\src\\salad.jpg"));
        ...
        // Grape Leaves
        JLabel grapeImg = new JLabel(new ImageIcon("C:\\Users\\HP\\Documents\\project visual\\practicle\\src\\grape leaves.jpg"));
    ...
    public static void main(String[] args) {
        new Welcome(); // Start  from the welcome window
    }
}